...
/**
 *
 * This Version of the application uses individual threads for each ball.
 *
 ...
 * Created by teren on 8/10/2016.
 */
public class MTBBA extends Application {
    ...
    private Slider ballCountSlider = new Slider(0, 200, 4);
